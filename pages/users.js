                    ...
                    <tr key={user._id} style={{ cursor: 'pointer' }}>
                        ...
                        <th>
...

                            {
                                        ...
                                        ? <i className="fas fa-trash-alt text-danger mx-3" title="Remove"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal" data-target="#exampleModal"
                                        onClick={() => dispatch({
                                            type: 'ADD_MODAL',
                                            payload: [{ data: users, id: user._id, title: user.name, type: 'ADD_USERS' }]
                                        })}></i>
                                        
                                        : <i className="fas fa-trash-alt text-danger mx-3" title="Remove"></i>
                            }
                        </th>
